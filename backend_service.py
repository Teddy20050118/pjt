...
def build_scope_query_payload(
    *,
    ...
    if is_sewer_vs_industry_query(query):
        ...
        elif "工業區" in query and "下水道" in query:
            answer = (
                "若食品工廠或其他廠商的廢水是排入工業區專用污水下水道，放流水端通常應先看"
                "《放流水標準》第2條附表十一的其他工業區專用污水下水道系統標準；"
                "事業端仍需另外確認工業區納管標準、許可文件與前處理要求。\n\n"
                "也就是說，不能只用一般食品工廠或其他事業的附表八取代工業區專用污水下水道系統標準。"
            )
            citation_items = [
                ("放流水標準第2條附表十一", "其他工業區專用污水下水道系統放流水水質項目及限值"),
